...
<script type="text/javascript">   
  window.onload = function(){
      ...
      document.getElementById("7005").className += " active";
  }
</script>
            ...
            <div class="card">
              <div class="card-content collapse show">
                <div class="card-body">
                    ...
                    <?php echo form_open('users/changepassword', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                    ...
                    <div class="form-body">
                      ...
                      <div class="text-right">
                          <button type="submit" id="submit-btn" class="btn btn-primary btn-min-width">Change</button>
                      </div>
                    </div>
                ...
                <div class="card-body text-center">
                    <?php 
                      if($userdetails->isActive == 1) {
					    echo "<a onclick=\"return confirm('Are you sure you want to delete customer account permanently?');\" href='".site_url('users/accountdeletepermanently/'.$userdata['id'])."' class='btn btn-danger btn-min-width text-white mr-5'>DELETE CUSTOMER ACCOUNT</a>";
                        echo "<a onclick=\"return confirm('Are you sure you want to deactivate customer account permanently?');\" href='".site_url('users/accountstatus/0/'.$userdata['id'])."' class='btn btn-danger btn-min-width text-white'>DEACTIVATE CUSTOMER ACCOUNT</a>";
                      }
                      else {
                        echo "<a onclick=\"return confirm('Are you sure you want to activate customer account permanently?');\" href='".site_url('users/accountstatus/1/'.$userdata['id'])."' class='btn btn-success btn-min-width text-white'>ACTIVATE CUSTOMER ACCOUNT</a>";
                      }
                    ?>
                </div>
              </div>
