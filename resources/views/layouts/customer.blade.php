            ...
            <div class="footer py-4 d-flex flex-lg-column bg-primary" id="kt_footer">
                <div class=" container-xxl">
                    <div class="text-dark text-center">
                        <span class="fw-semibold">{{ date('Y') }} &copy;</span> <a href="{{ route('front.home') }}" target="_blank" class="text-dark text-hover-success fw-semibold fs-6">{{ config('constants.COMPANY_NAME'); }}</a>
