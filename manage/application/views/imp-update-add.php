  ...
  window.onload = function(){
    ...
    <div class="content-header row">
      ...
      <div class="content-header-right btn-group-sm text-right col-md-4 col-12">
          <a href="<?php echo site_url('career'); ?>" target="_self" class="btn btn-outline-primary"><i class="la la-list-ol"></i> Update List</a>
      </div>
    </div>
                    ...
                    <?php echo form_open('site/addNoteData', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                        ...
                        <div class="form-body">
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="text" name="tags" class="form-control" required data-validation-required-message="Tag is required">
                        ...
                        <div class="form-actions text-right">
                          <a href="<?php echo site_url('site/impupdate'); ?>" class="btn btn-outline-light">CANCEL</a>
