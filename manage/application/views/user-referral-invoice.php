...
<div style="font-family: Sans-serif;font-size: 10pt;line-height: 14pt;color: #333333;">
    <div style="padding: 0 0.40in 0 0.55in;">
                ...
                <tr>
                  <td style="vertical-align:bottom;word-wrap:break-word;float:left;width:50%;text-align:left;">
                   ...
                   <td style="vertical-align:top;word-wrap:break-word;float:right;text-align:right;width:50%;">
                      <span style="font-size: 20pt;line-height:22pt;color: #817d7d;">REFERRAL<br/>INVOICE</span>
                      <br>
                ...
                <tr>
                  <td style="vertical-align:bottom;word-wrap: break-word;">
                      <div>
                          ...
                          <span style="line-height: 15pt;white-space: pre-wrap;" id="tmp_billing_address"><?php 
                              echo ($invdetails['refuserinfo']->city) ? $invdetails['refuserinfo']->city.", " : "";
                              echo ($invdetails['refuserinfo']->state) ? $invdetails['refuserinfo']->state : "";
                              echo "<br/>";
                              echo "(M) ".$invdetails['refuserinfo']->mobile."<br/>";
                              echo "(E) ".$invdetails['refuserinfo']->email."<br/>";
                              echo "Code: ".$invdetails['refuserinfo']->refcode; ?></span>
                      </div>
                  </td>
                </tr>
            </tbody>
            ...
            <tbody id="lineitem">
                <tr>
                    <td style="font-size: 9pt;border-bottom: 1px solid #e3e3e3;background-color: #ffffff;color: #000000;padding: 10px 0px 10px 10px;" valign="top">
                        <span style="word-wrap: break-word;" id="tmp_item_name">Customer Subscription Plan</span>
                        <br>
                    ...
                    <td style="font-size: 9pt;border-bottom: 1px solid #e3e3e3;background-color: #ffffff;color: #000000;text-align:right;padding: 10px 10px 10px 5px;word-wrap: break-word;" valign="top"><?php echo formatePriceIndia($invdetails['payoutinfo']->payout_amount); ?><br>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table style="width:100%;margin-top:3px;table-layout:fixed;border-spacing: 0;border-collapse: collapse;">
            <tbody>
                <!-- <tr>
                  <td style="float:right;text-align:right;font-size: 9pt;padding:5px 10px 5px 5px;word-wrap:break-word;width:70%;" align="right" valign="middle">- 5% TDS Amount
                  </td>
                  <td id="tmp_total" style="float:right;font-size: 9pt;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:30%;" align="right" valign="middle"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> <?php echo formatePriceIndia($invdetails['payoutinfo']->payout_amount * TDS_RATIO);  ?>
                  </td>
                </tr> -->
                <tr>
                  ...
                  <td id="tmp_total" style="float:right;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:30%;" align="right" valign="middle"><b><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>  <?php 
                      //$payamt = $invdetails['payoutinfo']->payout_amount - ($invdetails['payoutinfo']->payout_amount * TDS_RATIO);
                      echo formatePriceIndia($invdetails['payoutinfo']->payout_amount); 
                      ?></b>
                  </td>
                </tr>
            </tbody>
