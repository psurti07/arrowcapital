                  ...
                  <?php echo form_open('site/search', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                        <div class="form-body">
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <fieldset class="radio">
                                <label>
                                  <input type="radio" name="module" value="customer" <?php echo ($module == "customer") ? "checked" : ""; ?>> Customer
                                </label>
                              </fieldset>

                              <fieldset class="radio">
                                <label>
                                  <input type="radio" name="module" value="career" <?php echo ($module == "career") ? "checked" : ""; ?>> Career
                                </label>
                              </fieldset>

                              <fieldset class="radio">
                                <label>
                                  <input type="radio" name="module" value="bulksms" <?php echo ($module == "bulksms") ? "checked" : ""; ?>> Bulk SMS
                                </label>
                              </fieldset>
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="text" name="mobile" id="mobile" value="<?php echo $mobile; ?>" class="form-control" required data-validation-regex-regex="[0-9]+" maxlength="10">
                              <div class="help-block font-small-3"></div>
                            </div>
                          </div>
                        ...
                        <div class="form-actions text-right">
                          <button type="submit" id="submit-btn" class="btn btn-primary btn-min-width">SEARCH</button>
                        </div>
                    <?php echo form_close(); ?>
                </div>
              </div>
