<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-18459983809"></script>
    <script>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-MGDHT5GB');
    </script>
    <!-- End Google Tag Manager -->
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-9QGY8E61EV"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
