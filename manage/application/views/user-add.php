            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <?php echo form_open('users/addUser', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="fullname" id="fullname" aria-required="true"
                                            class="form-control" required data-validation-regex-regex="^[a-zA-Z ]*$">
                                        <div class="help-block font-small-3"></div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="mobile" id="mobile" class="form-control"
                                            aria-required="true" required data-validation-regex-regex="^[6789]\d{9}$"
                                            maxlength="10">
                                        <div class="help-block font-small-3"></div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 btn-group-toggle" data-toggle="buttons">
                                        <div class="btn-group">
                                            <label class="btn btn-outline-dark active">
                                                <input type="radio" name="usertype" value="1" autocomplete="off"
                                                    checked><i class="icon-briefcase"></i> Salaried
                                            </label>
                                            <label class="btn btn-outline-dark">
                                                <input type="radio" name="usertype" value="2" autocomplete="off"><i
                                                    class="icon-flag"></i> Self Employed
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="loanamount" id="loanamount" aria-required="true"
                                            class="form-control" min="10000" required
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="currentemi">Monthly EMI You are Already Paying <span
                                                class="required">*</span></label>
                                        <input type="text" name="currentemi" id="currentemi" aria-required="true"
                                ...
                                <h4 class="form-section"><i class="ft-credit-card"></i> Subscription Plan Details</h4>

                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="cardamount">Plan Amount</label>
                                        <input type="text" name="cardamount" id="cardamount" class="form-control"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="cardnumber">Subscription Number</label>
                            ...
                            <div class="form-actions text-right">
                                <button type="submit" id="submit-btn"
                                    class="btn btn-primary btn-min-width">CREATE</button>
                            </div>
                            <?php echo form_close(); ?>
