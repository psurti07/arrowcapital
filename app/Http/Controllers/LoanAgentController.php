...
class LoanAgentController extends Controller
{
        ...
        try {
            ...
            if ($txStatus == "PAYMENT_SUCCESS") {
                ...
                if ($isEntry == 0) {
                    ...
                    /* send email in brevo */
                    sendBrevoHtmlMail2($mailData, 'Congratulations! Payment for Arrow Capital’s Hire Agent plan has been successful.', $sendGreetings, 3, $attachments);
            ...
            if (isset($loanType, $applyId, $orderId) && $loanType !== null && $applyId !== null && $orderId !== null) {
                ...
                if (isset($responsecode) && $responsecode == 100) {
                    ...
                    $fbdata = array(
                        ...
                        'sourceurl' => 'https://arrowcapital.in/loan-agent/paymentSuccess'
                    );
    ...
    public function getOffer1(Request $request)
    {
        try {
            ...
            $returnUrl = 'https://arrowcapital.in/api/loan-agent/great-deal-offer-response';
    ...
    //         $orderid = number_format(microtime(true) * 1000, 0, '.', '');
    //         $returnUrl = 'https://arrowcapital.in/api/loan-agent/elite-offer-response';
    //         $password = trim(random_code(6));
    //         Session::put('orderid', $orderid);
    //         Session::save();
    ...
    public function getOffer3_cipherpay(Request $request)
    {
        try {
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://arrowcapital.in/api/loan-agent/ultra-saver-offer-response';
    ...
    public function getOffer5(Request $request)
    {
        try {
            ...
            $returnUrl = 'https://arrowcapital.in/api/loan-agent/big-benefit-offer-response';
