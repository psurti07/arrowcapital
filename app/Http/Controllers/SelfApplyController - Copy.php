            ...
            if ($txStatus == "PAYMENT_SUCCESS") {
                ...
                if ($isEntry == 0) {
                    ...
                    if (!$existingInvoice) {
                        ...
                        /* send email in brevo */
                        sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for Arrow Capital Self-Apply Plan.', $sendGreetings, 3, $attachments);
                    }
                    if ($response2 > 0) {
    ...
    public function buyDigitalPlan(Request $request)
    {
        try {
            ...
            if ($responseCode == 100){
                ...
                /* send email in brevo */
                sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for Arrow Capital’s Self-Apply Plan.', $sendGreetings, 3, $attachments);
