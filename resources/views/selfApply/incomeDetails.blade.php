                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-4 mb-2">
                                    <label for="form_mobile"
                                        class="position-static p-0 text-uppercase s-14 mb-2 fw-bold color--grey">enter monthly income</label>
                            ...
                            <div class="col-md-12 mb-2">
                                 <label for="form_mobile"
                                        class="position-static p-0 text-uppercase s-14 mb-2 fw-bold color--grey">enter current emi (if any)</label>
                                <div class="input-group r-12">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">&#8377;</span>
                                    </div>
                            ...
                            <div class="col-md-12 form-btn mt-2"> 
                                <button type="submit" class="btn submit processNowBtn btn--green-300 r-100 hover--tra-black text-uppercase"
                                    id="processNowBtn"
