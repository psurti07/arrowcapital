...
<script type="text/javascript">   
  window.onload = function(){
      document.getElementById("133").className += " active";
  }
</script>

    <div class="content-header row">
      <div class="content-header-left col-md-8 col-12 mb-1">
        <h1 class="content-header-title text-uppercase">Add Application File Remark</h1>
      </div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <?php echo form_open('site/addFileRemark', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                        <div class="form-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="text" name="title" class="form-control" required data-validation-required-message="Remark title is required">
                              <div class="help-block font-small-3"></div>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <textarea name="remarks" class="form-control" required data-validation-required-message="Remark content is required" rows="10"></textarea>
                              <div class="help-block font-small-3"></div>
                            </div>
                          </div>
                        </div>
