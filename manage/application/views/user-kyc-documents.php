...
<script type="text/javascript">   
  window.onload = function(){
      ...
      document.getElementById("7006").className += " active";
  }
</script>
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-md-6">
                          ...
                          if($documentlist->profilephoto == NULL) {
                            ...
                            echo anchor("users/reuploaddoc/profilephoto/{$userdata['id']}",'<i class="la la-exclamation-triangle"></i> Reupload','class="btn btn-icon btn-outline-success btn-sm ml-1"');
                          }
                          ?>
                        </dd>
                      </dl>
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-md-6">
                          ...
                          if($documentlist->aadharcard == NULL) {
                            ...
                            echo anchor("users/reuploaddoc/aadharcard/{$userdata['id']}",'<i class="la la-exclamation-triangle"></i> Reupload','class="btn btn-icon btn-outline-success btn-sm ml-1"');
                          }
                          ?>
                        </dd>
                      </dl>
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-md-6">
                          ...
                          if($documentlist->pancard == NULL) {
                            ...
                            echo anchor("users/reuploaddoc/pancard/{$userdata['id']}",'<i class="la la-exclamation-triangle"></i> Reupload','class="btn btn-icon btn-outline-success btn-sm ml-1"');
                          }
                          ?>
                        </dd>
                      </dl>
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-md-6">
                          ...
                          if($documentlist->lightbill == NULL) {
                            ...
                            echo anchor("users/reuploaddoc/lightbill/{$userdata['id']}",'<i class="la la-exclamation-triangle"></i> Reupload','class="btn btn-icon btn-outline-success btn-sm ml-1"');
                          }
                          ?>
                        </dd>
                      </dl>
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-md-6">
                          ...
                          if($documentlist->cancelcheque == NULL) {
                            ...
                            echo anchor("users/reuploaddoc/cancelcheque/{$userdata['id']}",'<i class="la la-exclamation-triangle"></i> Reupload','class="btn btn-icon btn-outline-success btn-sm ml-1"');
                          }
                          ?>
                        </dd>
                      </dl>
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-md-6">
                          ...
                          if($documentlist->bankstatement == NULL) {
                            ...
                            echo anchor("users/reuploaddoc/bankstatement/{$userdata['id']}",'<i class="la la-exclamation-triangle"></i> Reupload','class="btn btn-icon btn-outline-success btn-sm ml-1"');
                          }
                          ?>
                        </dd>
                      </dl>
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-md-6">
                          ...
                          if($documentlist->formsixteen == NULL) {
                            ...
                            echo anchor("users/reuploaddoc/formsixteen/{$userdata['id']}",'<i class="la la-exclamation-triangle"></i> Reupload','class="btn btn-icon btn-outline-success btn-sm ml-1"');
                          }
                          ?>
                        </dd>
                      </dl>
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-md-6">
                          ...
                          if($documentlist->salaryslip == NULL) {
                            ...
                            echo anchor("users/reuploaddoc/salaryslip/{$userdata['id']}",'<i class="la la-exclamation-triangle"></i> Reupload','class="btn btn-icon btn-outline-success btn-sm ml-1"');
                          }
                          ?>
                        </dd>
                      </dl>
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-md-6">
                          ...
                          if($documentlist->businessproof == NULL) {
                            ...
                            echo anchor("users/reuploaddoc/businessproof/{$userdata['id']}",'<i class="la la-exclamation-triangle"></i> Reupload','class="btn btn-icon btn-outline-success btn-sm ml-1"');
                          }
                          ?>
                        </dd>
                      </dl>
                      ...
                      <dl class="row">
                        ...
                        <dd class="col-md-6">
                          ...
                          if($documentlist->itreturn == NULL) {
                            ...
                            echo anchor("users/reuploaddoc/itreturn/{$userdata['id']}",'<i class="la la-exclamation-triangle"></i> Reupload','class="btn btn-icon btn-outline-success btn-sm ml-1"');
                          }
                          ?>
                        </dd>
                      </dl>
