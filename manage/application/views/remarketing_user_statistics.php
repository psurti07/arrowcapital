...
<script type="text/javascript">
	window.onload = function(){
		...
		document.getElementById("1417").className += " active";
		applicationdata();
	}
</script>
	...
	<div class="content-body">
		...
		<div class="row">
			<div class="col-12">
				<h2 class="text-bold-600 text-center">Intrekt Remarketing Users</h2>
				<hr />
			</div>
		</div>
	...
	<script type="text/javascript">
		function applicationdata() {
			$.ajax({
				url: "<?php echo base_url('dashboard/remarketingcrondata'); ?>",
				method: "POST",
				dataType: "JSON",
				cache: false,
				contentType: false,
				...
				success: function(response) {
						...
						if (response['success'] == true) {
							...
							$.each(response.statistics['digitalremarketing'], function(index, element) {
								...
								html += '<h3 class="text-bold-700" id="oldapplication">' + element.countrec + '</h3>';
						...
						/* Intrekt remarketing user data display */
