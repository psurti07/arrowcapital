...
<body class="font-f-1">
	<!--=====contact start=======-->
	<div class="contact2 sp1" style="background: radial-gradient(circle, rgba(138,215,189,1) 0%, rgba(44,59,118,1) 100%); height : 100vh; ">
		<div class="container">
			<div class="row">
					...
					<div class="col-md-6 contact2-form-box-all" style="border: 1px solid;">
						<div class="contact-form">
							...
							<div class="hadding2 text-center mb-4">
								<img class="img-fluid" src="<?= base_url('assets/img/logo/cashindia.png') ?>" alt="logo-image" width="200">
							</div>

							<div class="hadding2-w">
								<h4 class="s-30 mb-3">Lost your password?</h4>
								<h6 class="s-20">Please enter your mobile number. You will received new password via SMS.</h6>
							</div>
								...
								<div class="contact-inputs">
									<div class="contact-input">
										<div class="contact5-form-input m-0 form-group">
											<input type="text" name="mobile" class="form-control numeric-input mb-2" placeholder="Mobile No*" aria-required="true" id="mobile" required minlength="10" maxlength="10" inputmode="numeric" data-validation-regex-regex="^[6789]\d{9}$">
											<div class="help-block ms-0 ps-0 mb-2"></div>
										</div>

										<div class="space20"></div>
										<button class="button-h-2 btnfos2">Send</button>
										<div class="space20"></div>
