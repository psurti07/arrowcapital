...
-----END PUBLIC KEY-----';       //header key
        ...
        try {
            ...
            if ($user) {
                ...
                if (!$countSMS) {
                    ...
                    $generatedOtp = generateOtp($inputs['mobile'], $inputs['acc-type']);
                    if ($generatedOtp) {
   ...
   public function getOffer1(Request $request){
        ...
        try{
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $returnUrl = 'https://arrowcapital.in/api/self-apply/offer-1-response';
    ...
    public function getOffer2(Request $request){
        ...
        try{
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://arrowcapital.in/api/self-apply/offer-2-response';
    ...
    public function getOffer3(Request $request){
        ...
        try{
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://arrowcapital.in/api/loan-agent/offer-3-response';
