				...
				<tbody>
					<tr>
						<td style="vertical-align:bottom;word-wrap:break-word;float:left;width:50%;text-align:left;">
							<b style="font-size:14pt;">Cashindia</b><br>
							<b><?php echo COMPANY_NAME;?></b><br/>
							<div>
								<span style="white-space: pre-wrap;" id="tmp_org_address">1st Floor, Plot-29,<br/>Parvati Nagar Co Op H Society-2,<br/>Katargam Road, RS No.-123/1 Paiky, Surat - 395004<br/>Mo.: <?php echo COMPANY_MOBILE;?><br/>Email: <?php echo COMPANY_EMAIL;?><br/>LLP No.: <?php echo COMPANY_LLP;?><br/>GST No.: <?php echo COMPANY_GST;?></span>
							</div>
						</td>
						<td style="vertical-align:top;word-wrap:break-word;float:right;text-align:right;width:50%;">
							...
							<div style="clear:both;margin-top:20px;">
								...
								<br>
								<b><?php echo displayDate($invdetails['invoiceinfo']->inv_date); ?></b>
								<br>
							</div>
						</td>
					</tr>
				...
				<tr>
					<td style="vertical-align:bottom;word-wrap: break-word;">
						<div>
							...
							<strong><?php echo $invdetails['userinfo']->fullname; ?></strong><br>
							<span style="white-space: pre-wrap;" id="tmp_billing_address"><?php
								echo ($invdetails['userinfo']->city) ? $invdetails['userinfo']->city.", " : "";
								echo ($invdetails['userinfo']->state) ? $invdetails['userinfo']->state : "";
								echo "<br/>";
								echo "(M) ".$invdetails['userinfo']->mobile."<br/>";
								echo "(E) ".$invdetails['userinfo']->email."<br/>"; ?></span>
						</div>
					</td>
				</tr>
				</tbody>
			...
			<table style="width:100%;margin-top:20px;table-layout:fixed;border-spacing: 0;border-collapse: collapse;" class="pcs-itemtable" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td style="font-size: 10pt;border-bottom: 1px solid #e3e3e3;color: #000000;padding: 10px 0px 10px 10px;" valign="top">
						<span style="word-wrap: break-word;" id="tmp_item_name"><?php echo ($invdetails['userinfo']->cardtype==12)? "Business Subscription Plan" : "Personal Subscription Plan"; ?></span>
						<br>
						<span style="color: #525252;white-space: pre-wrap;word-wrap: break-word;" id="tmp_item_description">Subscription Number - <?php echo $invdetails['orderinfo']->card_number; ?></span>
						<br>
					...
					<td style="font-size: 10pt;border-bottom: 1px solid #e3e3e3;background-color: #ffffff;color: #000000;padding: 10px 10px 5px 10px;text-align:right;word-wrap: break-word;" valign="top">
						<span id="tmp_item_qty">1</span>
						<br>
					</td>
					<td style="font-size: 10pt;border-bottom: 1px solid #e3e3e3;color: #000000;text-align:right;padding: 10px 10px 10px 5px;word-wrap: break-word;" valign="top"><?php echo formatePriceIndia($invdetails['invoiceinfo']->inv_price); ?>
					</td>
				</tr>
				</tbody>
			</table>
			...
			<table style="width:100%;margin-top:30px;table-layout:fixed;border-spacing: 0;border-collapse: collapse;">
				...
				<tr>
					...
					<td style="vertical-align:bottom;word-wrap:break-word;float:right;width:50%;text-align:right;">
						<p style="margin-top:20px;white-space: pre-wrap;word-wrap: break-word;font-size: 8pt;"><em>Authorized person</em><br/><span style="margin-top:20px;margin-bottom:7px;"><strong><?php echo COMPANY_NAME;?></strong></span></p>
					</td>
				</tr>
				</tbody>
			</table>
