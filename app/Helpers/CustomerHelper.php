		...
		function convertIntoCustomer($cardno, $userData, $cardData, $orderAmount, $txnId, $accType, $slug, $prefix, $offerpage) {
		    try {
                ...
                try
                {
                    ...
                    $subject = (($accType == 2)
                        ? 'Congratulations! Payment for Arrow Capital’s Hire Agent plan has been successful.'
                        : (($accType == 3) 
                        ? 'Congratulations! Payment for Arrow Capital’s Self-Apply plan has been successful.'
                        : 'Congratulations! Payment Successful for Arrow Capital’s Self-Apply Plan.'));
