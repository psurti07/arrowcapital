        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div class="header-content">
                    <h5 class="mb-0">{{ config('constants.COMPANY_NAME'); }}</h5>
    ...
    /*$(document).ready(function () {
        ...
        function updateCountdown() {
            ...
            if (countdownTime <= 0) {
                ...
                window.location.href = "https://arrowcapital.in/";
                return;
            }
        ...
        function checkResponse() {
            $.ajax({
                url: "https://arrowcapital.in/status-enquiry", // Replace with your API endpoint
