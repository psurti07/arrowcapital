...
<script type="text/javascript">   
  window.onload = function(){
      ...
      document.getElementById("1416").className += " active";
      //processstepdata();
  }
</script>
  ...
  <div class="content-body">
	<div class="row">
		<div class="col-12">
	      <h2 class="text-bold-600 text-center">Process Steps Statistics - <?php echo date('d M, Y'); ?></h2><hr/>
	  	</div>
		  <div class="col-12">
	...
	<div class="row">
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/1'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="userregistration"><?php echo  $statistics['userregistration'] ?></h3>
			          <span>User Registration</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">1</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/2'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="usereligibility"><?php echo  $statistics['usereligibility'] ?></h3>
			          <span>Check Eligibility</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">2</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/3'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="userpreapproved"><?php echo  $statistics['userpreapproved'] ?></h3>
			          <span>Pre-approved</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">3</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/4'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="subscriptionplan"><?php echo  $statistics['subscriptionplan'] ?></h3>
			          <span>Subscription Plan</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">4</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/5'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="userverification"><?php echo  $statistics['userverification'] ?></h3>
			          <span>User Verification</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">5</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/6'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="docverification"><?php echo  $statistics['docverification'] ?></h3>
			          <span>Document Verification</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">6</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/7'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="appinprocess"><?php echo  $statistics['appinprocess'];?></h3>
			          <span>Application - In Process</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">7</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/8'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="appqueryprocess"><?php echo $statistics['appqueryprocess'] ?></h3>
			          <span>Application - Query Process</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">8</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/9'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="appfilereopen"><?php echo $statistics['appfilereopen'] ?></h3>
			          <span>Application - File Reopen</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">9</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/10'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="apprejected"><?php echo $statistics['apprejected']?></h3>
			          <span>Application - Rejected</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">10</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up bg-success bg-accent-3">
			  <div class="card-content">
			    <div class="card-body">
			    <a href="<?php echo site_url('report/processstep/11'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-dark text-left">
			          <h3 class="text-dark" id="appapproved"><?php echo $statistics['appapproved']?></h3>
			          <span>Application - Approved</span>
			        </div>
			        <div><i class="la text-dark font-large-1 float-right">11</i></div>
			      </div>
			    </a>
			    </div>
			  </div>
...
/*function processstepdata(){
      ...
      beforeSend:function(){
          ...
          document.getElementById('subscriptionplan').innerHTML = "<i class='la la-spinner spinner'></i>";
      ...
      success: function(response) {
          if(response['success'] == true) {
            ...
            document.getElementById('subscriptionplan').innerHTML = response['statistics']['subscriptionplan'];
