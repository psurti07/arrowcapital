...
<script type="text/javascript">   
  ...
  <div class="content-header row">
      ...
      <div class="btn-group">
        <button type="button" class="btn btn-primary btn-min-width btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Status</button>
        <div class="dropdown-menu">
          <a class="dropdown-item" href="<?php echo site_url('support/changeticketstatus/1/'.$details->id); ?>">Open</a>
          <a class="dropdown-item" href="<?php echo site_url('support/changeticketstatus/2/'.$details->id); ?>">Processing</a>
          <a class="dropdown-item" href="<?php echo site_url('support/changeticketstatus/3/'.$details->id); ?>">Closed – No Response</a>
          <a class="dropdown-item" href="<?php echo site_url('support/changeticketstatus/4/'.$details->id); ?>">Solved</a>
        </div>
      </div>
              ...
              <div class="card-content">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                      Ticket No. : <strong class="font-medium-3"><?php echo $details->ticketno; ?></strong>
                    </li>
                    ...
                    <li class="list-group-item">
                      Email Id : <strong><?php echo $details->emailid; ?></strong>
                    </li>

                    <li class="list-group-item">
                      Card No. : <strong><?php echo $details->cardnumber; ?></strong>
                    </li>
                </ul>
              </div>
            </div>
                  ...
                  <fieldset>
                    <div class="input-group">
                      ...
                      <div class="input-group-append">
                        <button type="submit" id="submit-btn" class="btn btn-light bg-light border-light"><i class="la la-check"></i></button>
                      </div>
                    </div>
                  </fieldset>
                <?php echo form_close(); ?>
