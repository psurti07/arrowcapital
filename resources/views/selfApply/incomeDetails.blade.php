                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-4 mb-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="monthly_income" id="monthly_income" class="numeric-input form-control mb-0" placeholder="Enter Monthly Income (&#8377;)" autocomplete="off" inputmode="numeric">
                                    </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="current_emi" id="current_emi" value="" class="numeric-input form-control mb-0" placeholder="Enter Current EMI (&#8377;) (If Any)" autocomplete="off" inputmode="numeric">
                                    </div>
                                </div>
