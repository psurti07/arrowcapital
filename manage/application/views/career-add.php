  ...
  window.onload = function(){
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-8 col-12 mb-1">
        <h1 class="content-header-title text-uppercase">Add Current Opening</h1>
      </div>
      <div class="content-header-right btn-group-sm text-right col-md-4 col-12">
          <a href="<?php echo site_url('career'); ?>" target="_self" class="btn btn-outline-primary"><i class="la la-list-ol"></i> Current Opening List</a>
      </div>
    </div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <?php echo form_open('career/addCareer', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>

                        <div class="form-body">
                          <div class="form-group">
                            <h5>Job Title <span class="required">*</span></h5>
                            <div class="controls">
                              <input type="text" name="co_title" class="form-control" required data-validation-required-message="Job title is required">
                          ...
                          <div class="form-group">
                            <h5>Description</h5>
                            <div class="controls">
                              <textarea name="co_description" class="ckeditor"></textarea>
                            </div>
                          </div>
                        </div>
