  ...
  window.onload = function(){
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-8 col-12 mb-1">
        <h1 class="content-header-title text-uppercase">Edit Bank</h1>
      </div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <?php echo form_open_multipart('banks/editBank', array('id'=>'submitForm', 'class'=>'form-horizontal', 'enctype'=>'multipart/form-data', 'novalidate'=>'novalidate')); ?>
                        <input type="hidden" name="id" value="<?php echo $bankdetails->id; ?>" required>

                        <div class="form-body">
                          <div class="form-group">
                            <h5>Bank Name <span class="required">*</span></h5>
                            <div class="controls">
                              <input type="text" name="bank_name" class="form-control" value="<?php echo $bankdetails->bank_name; ?>" required data-validation-required-message="Bank name is required">
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="file" name="bank_image" class="form-control" accept="image/*">
                              <div class="help-block font-small-3"></div>
                          ...
                          <div class="form-group">
                            <h5>Order No</h5>
                            <div class="controls">
                              <input type="number" name="order_no" class="form-control" value="<?php echo $bankdetails->order_no; ?>">
                            </div>
                          </div>
                        </div>
