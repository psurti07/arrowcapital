...
<script type="text/javascript">
  window.onload = function() {
    document.getElementById("148").className += " active";
  }
</script>

<div class="content-header row">
  <div class="content-header-left col-md-6 col-12 mb-1">
    <h1 class="content-header-title text-uppercase">DND User List</h1>
  </div>
                ...
                <tbody>
                  ...
                  if (count($userlist)) {
                    ...
                    foreach ($userlist as $row) {
                      ...
                      echo "<td class='text-center' width='50'>" . anchor("sms/deletedndno/{$row->id}", '<i class="la la-trash"></i>', 'class="btn btn-icon btn-outline-danger btn-sm"') . "</td>";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open_multipart('sms/uploaddndfile', array('id' => 'submitForm', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
