  ...
  <div class="card">
    <div class="card-content collapse show">
        <div class="list-group">
          ...
          <a href="<?php echo site_url('users/payoutdocuments/'.$userdata['id']); ?>" id="7007" class="list-group-item list-group-item-action">Payout Documents</a>

          <a href="<?php echo site_url('users/subscriptionplan/'.$userdata['id']); ?>" id="7002" class="list-group-item list-group-item-action">Subscription Plan</a>
