<head>
  ...
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=AW-16995133966"></script>
  <script>
    ...
    gtag('config', 'AW-16995133966');
  </script>

  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-6HS8TFRSMQ"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-P4VRF8BX');
  </script>
