...
-----END PUBLIC KEY-----';       //header key
    ...
    public function StatusEnquiry(Request $request)
    {
        ...
        $actualReturnUrl = $secondLastSegment === 'self-apply' ? 'https://arrowcapital.in/self-apply/premium-offer-response' : 'https://arrowcapital.in/loan-agent/ultra-saver-offer-response';

        $redirectUrl = $paymentMessage === 'Transaction Successfull' ? $actualReturnUrl : 'https://arrowcapital.in/cipher-payment-failed/';
