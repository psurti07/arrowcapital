                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 btn-group-toggle" data-toggle="buttons">
                                        <div class="btn-group">
                                            <label
                                                class="btn btn-outline-primary <?php echo ($userdetails['userinfo']->usertype == 1) ? 'active' : ''; ?>">
                                                <input type="radio" name="usertype" value="1" autocomplete="off"
                                                    <?php echo ($userdetails['userinfo']->usertype == 1) ? 'checked' : ''; ?>><i
                                                    class="icon-briefcase"></i> Salaried
                                            </label>
                                            <label
                                                class="btn btn-outline-primary <?php echo ($userdetails['userinfo']->usertype == 2) ? 'active' : ''; ?>">
                                                <input type="radio" name="usertype" value="2" autocomplete="off"
                                                    <?php echo ($userdetails['userinfo']->usertype == 2) ? 'checked' : ''; ?>><i
                                ...
                                <div class="form-group text-right">
                                    <button type="submit" id="submit-btn"
                                        class="btn btn-primary btn-min-width">SAVE</button>
                                </div>
                            </div>
