...
<script type="text/javascript">   
  window.onload = function(){
      ...
      document.getElementById("7002").className += " active";
  }
</script>
  ...
  <div class="content-header row">
	  <div class="content-header-left col-md-8 col-12 mb-1">
        <div class="badge badge-pill badge-light badge-square">Customer</div>
  	    <h1 class="content-header-title text-uppercase">Subscription Plan Details</h1>
              ...
              <div class="card-content collapse show">
                <div class="card-body">
                  ...
                  <div class="text-right">
                    <a href="<?php echo site_url('users/downloadinvoice/'.$userdata['id'].'/'.$carddetails->id); ?>" target="_blank" class="btn btn-primary btn-sm text-white">Download Invoice</a>
                    <hr/>
                  </div>

                  <dl class="row">
                    <dd class="col-md-4">Subscription Type :</dd>
                    <dt class="col-md-8 text-capitalize">
                      <?php 
                      if($userdata['cardtype'] == 11) {
                        echo "Personal Subscription Plan";
                      }
                      else if($userdata['cardtype'] == 12) {
                  ...
                  <dl class="row">
                    <dd class="col-md-4">Subscription Number :</dd>
                  ...
                  <dl class="row">
                    <dd class="col-md-4">Subscription Status :</dd>
