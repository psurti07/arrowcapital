              ...
              <div class="card-content collapse show">
                <div class="card-body">
                    <dl class="row">
                      ...
                      <dt class="col-md-8"><?php echo anchor("users/userdetails/{$appdetails->userid}",$appdetails->fullname,'class="text-capitalize"'); ?></dt>
                    </dl>
                    <hr/>
                    ...
                    <dl class="row">
                      ...
                      <dt class="col-md-8"><?php echo displayDate($appdetails->rec_date); ?></dt>
                    </dl>
                    <hr/>
