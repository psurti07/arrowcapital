	...
	<div class="section-lg">
		<div class="container">
			<div class="bg-white p-lg-5  border-radius-1 box-shadow n-margin-5">
				<div class="row align-items-center g-4 g-lg-5 p-3">
					<div class="col-12 col-lg-6">
						<div class="border border-dark border-radius-1 p-5">
						<h3 class="text-dark text-center">Password Reset</h2>
							<form action="" id="submitForm1" method="post">
								<div class="col-md-12 col-sm-12 p-2">
									<label>Mobile</label>
									<input type="text" name="mobile" class="border-radius mb-0" placeholder="Mobile No" id="mobile" required minlength="10" maxlength="10" inputmode="numeric">
									<div class="text-danger" id="mobile-message"></div>
								</div>
								
								
								<div class="col-md-12 col-sm-12 p-2 text-center">
									<button class="button-dark button-xl button-radius button-turquiose " id="form-submit1" type="submit">Send</button>
								</div>
							</form>
							<div class="col-md-12 col-sm-12 p-2 text-center">
								<p class="text-dark">Already have an account? <a class="fw-semi-bold" href="<?=base_url('customer')?>">Login Now</a></p>
							</div>
						</div>
					</div>
					<div class="col-12 col-lg-6">
						<div class="row">
							<div class="col-12 pt-4 ">
								<img class="img-fluid" src="<?=base_url('assets/images/slider/reset.png')?>" alt="" >
							</div>
			...
			<div class="col-lg-6 col-md-8 m-auto">
				<div class="sign-form-wrap">
					<div class="sign-logo text-center">
						<a href="javascript:;"><img src="<?=base_url('assets/img/logo/cashe-credit.png')?>" alt="" width="140" /></a>
					</div>
					<div class="sign-form">
						<div class="form-heading">
							<h3 class="font-22">Password Reset</h3>
						</div>
						...
						<form action="" id="submitForm1" method="post">
							...
							<button type="submit" id="form-submit1" class="theme-btn-11 full-btn"> Send </button>
						</form>
						<div class="space20"></div>
						<h4 class="font-14">
							Already have an account?
							<a href="<?=base_url('customer')?>">Login Now</a>
						</h4>
					</div>
				</div>
			</div>
	...
	$(document).ready(function(){
		$("#submitForm1").validate({
			...
			submitHandler: function (form) {
				$.ajax({
					url : `<?php echo base_url('customer/login/sendForgetmessage')?>`,
					type: "POST",
					data: $(form).serialize(),
					dataType: "JSON",
					cache: false,
					processData:false,
					beforeSend: function(){
						$('#form-submit1').html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> SENDING...');
