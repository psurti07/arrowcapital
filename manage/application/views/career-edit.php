                    ...
                    <?php echo form_open('career/editCareer', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                        ...
                        <div class="form-body">
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="text" name="co_title" class="form-control" value="<?php echo $careerdetails->title; ?>" required data-validation-required-message="Job title is required">
                          ...
                          <div class="form-group">
                            <h5>Description</h5>
                            <div class="controls">
                              <textarea name="co_description" class="ckeditor"><?php echo $careerdetails->descriptions; ?></textarea>
                            </div>
                          </div>
