                                                                                ...
                                                                                <tr>
                                                                                    <td style="padding: 0 20px; background-color: #fcffeb; color: #000; font-size: 16px; border-radius: 12px;font-family: Poppins, sans-serif;">
                                                                                        <table width="100%" style="width: 100%;">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><h5 style="margin:0">{{ $agent->fullname ?? 'Arrow Capital Support' }}</h5></td>
                                                                                                <td><h5 style="margin:0">+91 {{ $agent->mobile ?? '97242 06519' }}</h5></td>
                                                                                                <td><h5 style="margin:0">{{ $agent->emailid ?? 'info@arrowcapital.in' }}</h5></td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <table class="offers-table">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr style="font-family: Poppins, sans-serif;">
                                                                                        ...
                                                                                        <td><img src="https://manage.arrowcapital.in/upload/banks/{{ $offer->bank_image }}" alt="{{ $offer->bank_name }}" class="bank-logo"></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center"
                                                                                            ...
                                                                                            <p style="
                                                                                                ...
                                                                                                font-size: 12px;
                                                                                                "> 
                                                                                                {{ date('Y')}} &copy; {{ config('constants.COMPANY_NAME'); }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
