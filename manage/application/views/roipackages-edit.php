                    ...
                    <?php echo form_open('banks/editRoiPackage', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                        <div class="form-body">
                          ...
                          <div class="form-group btn-group-toggle" data-toggle="buttons">
                            <div class="btn-group">
                              <label class="btn btn-outline-primary <?php echo ($packagedetails->loantype == 11) ? 'active' : ''; ?>">
                                <input type="radio" name="loantype" value="11" autocomplete="off" <?php echo ($packagedetails->id == 11) ? 'checked' : ''; ?>>Personal Loan
                              </label>
                              <label class="btn btn-outline-primary <?php echo ($packagedetails->loantype == 12) ? 'active' : ''; ?>">
                                <input type="radio" name="loantype" value="12" autocomplete="off" <?php echo ($packagedetails->id == 12) ? 'checked' : ''; ?>>Business Loan
                              </label>
                            </div>
                          </div>
