  ...
  <footer class="footer footer-static footer-light navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block"><?php echo date('Y')." &copy; ".COMPANY_NAME; ?> </span>
    </p>
  </footer>
  ...
  <script src="<?php echo base_url('assets/vendors/js/tables/datatable/dataTables.responsive.min.js'); ?>" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url('assets/vendors/js/forms/spinner/jquery.bootstrap-touchspin.js'); ?>" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url('assets/vendors/js/forms/toggle/bootstrap-switch.min.js'); ?>" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url('assets/vendors/js/editors/ckeditor/ckeditor.js'); ?>" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url('assets/js/scripts/tables/datatables-extensions/datatable-button/datatable-html5.js'); ?>" type="text/javascript"></script>
