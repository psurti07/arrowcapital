...
<div class="owl-carousel reviews-1-wrapper-testimonial">
    <div class="row align-items-center justify-content-center m-auto">
        ...
        <div class="col-md-5">
            <p class="mb-3">
                "It’s been an amazing experience with Arrow Capital. From the very beginning until the end, I received the best services from them. I strongly recommend Arrow Capital to all. "
            </p>
    ...
    <div class="row align-items-center justify-content-center m-auto">
        ...
        <div class="col-md-5">
            <p class="mb-3">
                "The self-apply feature is very easy. It has given all the clear directions. Even if there are any doubts, their customer support team is also very strong and supportive."
            </p>
            <div class="author-data clearfix">
                <div class="review-avatar">
                    <img src="{{ asset('front/images/logo/apple-touch-icon.png') }}" alt="review-avatar" width="auto">
    ...
    <div class="row align-items-center justify-content-center m-auto">
        ...
        <div class="col-md-5">
            <p class="mb-3">
                "I am very happy with the service of Arrow Capital. The process was extremely simple, and my loan agent was both friendly and knowledgeable. Strongly recommended!"
            </p>
            <div class="author-data clearfix">
                <div class="review-avatar">
                    <img src="{{ asset('front/images/logo/apple-touch-icon.png') }}" alt="review-avatar" width="auto">
    ...
    <div class="row align-items-center justify-content-center m-auto">
        ...
        <div class="col-md-5">
            <p class="mb-3">
                "When I needed the money urgently, Arrow Capital became a lifesaver for me. I am extremely grateful to the entire team for helping me in processing my loan quickly. "
            </p>
            <div class="author-data clearfix">
                <div class="review-avatar">
                    <img src="{{ asset('front/images/logo/apple-touch-icon.png') }}" alt="review-avatar" width="auto">
