...
<div class="section-lg bg-image parallax"  style="background: #e9f0f7">
		...
		<div class="container">
			<div class="row align-items-center g-3 g-lg-3">
				...
				<div class="col-12 pt-4 pb-4">
					<h5 class="text-center mt-3 mb-3">Loan Facility Provided by Our Lending Partners</h5>
					<div class="owl-carousel" data-owl-dots="false" data-owl-nav="false" data-owl-autoplay="true" data-owl-margin="40" data-owl-xs="2" data-owl-sm="3" data-owl-md="6" data-owl-lg="6" data-owl-xl="6">
...
<?php if ($processstep == 'step1'): ?>
<?php 		
	$testimonialimg = array('42.jpg','43.jpg', '44.jpg', '45.jpg', '46.jpg', '47.jpg', '48.jpg');
?>
