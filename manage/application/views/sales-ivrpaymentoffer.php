...
<script type="text/javascript">   
  window.onload = function(){
      ...
      document.getElementById("1351").className += " active";
  }
</script>

  <div class="content-header row">
	  <div class="content-header-left col-md-12 col-12 mb-1">
	    <h1 class="content-header-title text-uppercase">IVR Payment Offer Sales</h1>
	  </div>
	</div>
            ...
            <div class="card">
              ...
              <div class="card-header">
                <div class="heading-elements">
                    <?php echo form_open('offer/ivrpaymentoffer', array('id'=>'filterForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                    ...
                    <tbody>
                      ...
                      <?php
                        if(count($saleslist)) {
                            ...
                            if($row->isCustomer == 1) {
                              echo "<td class='text-center'>".anchor("offer/offerstatus/4/{$row->isCustomer}/{$row->id}",'Customer','class="btn btn-icon btn-outline-primary btn-sm"')."</td>";
                            }
                            else {
                              echo "<td class='text-center'>".anchor("offer/offerstatus/4/{$row->isCustomer}/{$row->id}",'Lead','class="btn btn-icon btn-outline-success btn-sm"')."</td>";
                            }
