...
<script type="text/javascript">   
  ...
  <div class="content-header row">
	  <div class="content-header-left col-md-12 col-12 mb-1">
	    <h1 class="content-header-title text-uppercase">Customers - KYC Unverified Documents</h1>
	  </div>
	</div>
                      ...
                      <?php
                        if(count($userlist)) {
                            ...
                            echo "<td>".htmlentities($row->state)."</td>";
                        		echo "<td class='text-center' width='50'>".anchor("users/kycdocuments/{$row->id}",'<i class="la la-info"></i>','class="btn btn-icon btn-outline-dark btn-sm"')."</td>";
