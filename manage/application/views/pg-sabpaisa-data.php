...
<script type="text/javascript">   
  window.onload = function(){
      document.getElementById("170").className += " active";
  }
</script>

  <div class="content-header row">
	  <div class="content-header-left col-md-12 col-12 mb-1">
	    <h1 class="content-header-title text-uppercase">Sabpaisa Log</h1>
	  </div>
	</div>
            ...
            <div class="card">
              ...
              <div class="card-header">
                <div class="heading-elements">
                    <?php echo form_open('payment/sabpaisalog', array('id'=>'filterForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
