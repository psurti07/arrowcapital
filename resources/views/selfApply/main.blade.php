        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-6 col-lg-6 col-md-6  col-12 mt-sm-0 pt-md-0 pt-10 order-2 mb-md-0 mb-3">
                    ...
                    <span class="color--green-300 mb-2 d-block w-600">🔶 Simple Loan Application Assistance </span>
                    <h1>Explore Loan Options That Suit <span class="color--green-300">Your Needs</span></h1>
                    <p>Explore loan options from multiple NBFC/Lending Partners and complete your application online.
                        Approval, terms and disbursement are subject to lender eligibility and policies.</p>
                    <ul class="icon-list d-flex flex-column flex-lg-row align-items-lg-center  mb-7 review-text mt-3 justify-content-between">
                        <li class="ps-0 me-md-2 mb-2 text-navy d-flex"><span class="me-2"> <i
                                    class="fas fa-bolt color--theme"></i></span><p class="s-12 p-sm mt-0">Quick Online Application</span></li>
                        <li class="mt-0 ps-0 me-md-2 mb-2 text-navy d-flex"><span class="me-2"><i
                                    class="fas fa-lock color--theme"></i></span><p class="s-12 p-sm mt-0">Secure Online Process</span></li>
                        <li class="mt-0 ps-0 me-md-2 mb-2 text-navy d-flex"><span class="me-2"> <i
                                    class="fas fa-trophy color--theme"></i></span><p class="s-12 p-sm mt-0">Customer-Focused Assistance</span>
                        </li>
                    </ul>
                    <!-- FEATURES-6 WRAPPER -->
                    <div class="fbox-wrapper text-center mt-3">
                        <div class="row row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-xl-2 row-cols-xl-4 gx-3 gy-3">
                            <div class="col d-flex">
                                <div class="fbox-12 bg--white-100 border r-12 h-100 w-100">
                            ...
                            <div class="col d-flex">
                                <div class="fbox-12 bg--white-100 border r-12 h-100 w-100">
                                    ...
                                    <div class="fbox-txt text-start">
                                        <h6 class="s-15 w-700 mb-0 color--blue-500">Online Application</h6>
                                        <p class="s-12 mt-0">Process</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col d-flex">
                            ...
                            <div class="col d-flex">
                                <div class="fbox-12 bg--white-100 border r-12 h-100 w-100">
                                    ...
                                    <div class="fbox-txt text-start">
                                        <h6 class="s-15 w-700 mb-0 color--blue-500">Explore </h6>
                                        <p class="s-12 mt-0">EMI Options</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div id="hero-8-form" class="bg-white shadow r-22 p-4">
                        <span class="text-uppercase color--green-300 d-block text-center w-700">Start Your Loan </span>
                        <h3 class="s-28 w-700 mb-20 text-center">Explore Loan Options up to <span
                                class="color--green-300">₹10 Lakhs</span></h3>
                                                ...
                                                <fieldset class="picker1">
                                                    <label class="card r-14" for="personalloan">
                                                        <input type="radio" name="loan_type" id="personalloan"
                                                            value="1" {{ ($loan_type ?? '') == 1 ? 'checked' : '' }}
                                                            class="radio" checked>
                                                        <span class="plan-details">
                                                            <span class="plan-type color--blue-500 s-16">Personal
                                                                Loan</span>
                                                        </span>
                                                    </label>
                                                </fieldset>
                                                ...
                                                <fieldset class="picker1">
                                                    <label class="card r-14" for="businessloan">
                                                        <input type="radio" name="loan_type" id="businessloan"
                                                            value="2" class="radio">
                                                        <span class="plan-details">
                                                            <span class="plan-type color--blue-500 s-16">Business
                                                                Loan</span>
                                                        </span>
                                                    </label>
                                                </fieldset>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-6 col-12 mb-2">
                                                <fieldset class="picker1">
                                                    <label class="card r-14" for="salaried">
                                                        <input type="radio" name="user_type" id="salaried"
                                                        ...
                                                        <span class="d-flex align-items-center p-md-3 p-2 r-14">
                                                            ...
                                                            <span class="plan-details p-0 ms-2">
                                                                <span
                                                                    class="plan-type color--blue-500 s-16">Salaried</span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                </fieldset>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-6 col-12 mb-2">
                                                <fieldset class="picker1">
                                                    <label class="card r-14" for="selfemployed">
                                                        <input type="radio" name="user_type" id="selfemployed"
                                                            value="2" class="radio">
                                                        <span class="d-flex align-items-center p-md-3 p-2 r-14">
                                                            <div
                                                                class="fbox-ico fbox-ico-1 d-flex align-items-center justify-content-start mb-0">
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-6 col-12 mb-2">
                                                <fieldset class="picker1">
                                                    <label class="card r-14" for="smallbusiness">
                                                        <input type="radio" name="user_type" id="smallbusiness"
                                                            value="3" class="radio" checked>
                                                        <span class="d-flex align-items-center p-md-3 p-2 r-14">
                                                            <div
                                                                class="fbox-ico fbox-ico-1 d-flex align-items-center justify-content-start mb-0">
                                                                <div class="fbox-image  ico-20 btn--green-300">
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-6 col-12 mb-2">
                                                <fieldset class="picker1">
                                                    <label class="card r-14" for="auditedreport">
                                                        <input type="radio" name="user_type" id="auditedreport"
                                                            value="4" class="radio">
                                                        <span class="d-flex align-items-center p-md-3 p-2 r-14">
                                                            <div
                                                                class="fbox-ico fbox-ico-1 d-flex align-items-center justify-content-start mb-0">
                                ...
                                <div class="col-md-12 text-start">
                                    ...
                                    <div class="input-group r-12">
                                        ...
                                        <input type="text" name="mobile" id="mobile"
                                            ...
                                            placeholder="Enter Mobile number" autocomplete="off" required maxlength="10"
                                ...
                                <div class="col-md-12">
                                    <div class="custom-control custom-checkbox d-flex align-items-start">
                                        <label class="mb-0 s-14 text-start text-dark"><small class="ms-2 d-block">By
                                                submitting, you agree to Arrow Capital's <a
                                                    href="{{ route('front.terms.conditions') }}" target="_blank"
                                                    class="text-dark text-decoration-none">Terms of Use</a>
                                                and <a href="{{ route('front.privacy.policy') }}"
                                                    class="text-dark text-decoration-none" target="_blank">Privacy
                                                    Policy</a>and consent to receive promotional and informational messages
                                                via email, call, or SMS.</small></label>
                                    </div>
                                </div>
                        </form>
                    </div>
                            ...
                            <div
                                ...
                                <div class="fbox-ico fbox-ico-1 d-flex align-items-center justify-content-start mb-0">
                                    <div class="d-flex">
                                        ...
                                        <div class="fbox-txt ms-3">
                                            <span class="color--grey text-uppercase mb-1 w-600 d-block s-14">Minimum Salary</span>
                                            <h6 class="w-700 s-16 color--blue-500 mb-0 s-14"> ₹15,000/month</h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div class="fbox-ico fbox-ico-1 d-flex align-items-center justify-content-start mb-0">
                                    <div class="d-flex">
                                        ...
                                        <div class="fbox-txt ms-3">
                                            <span class="color--grey text-uppercase mb-1 w-600 d-block s-14">Job Stability</span>
                                            <h6 class="w-700 s-16 color--blue-500 mb-0 s-14">Minimum 1 Year </h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="fbox-ico ico-14">
                            ...
                            <div
                                ...
                                <div class="fbox-ico fbox-ico-1 d-flex align-items-center justify-content-start mb-0">
                                    <div class="d-flex">
                                        ...
                                        <div class="fbox-txt ms-3">
                                            <span class="color--grey text-uppercase mb-1 w-600 d-block s-14">Age Requirement</span>
                                            <h6 class="w-700 s-16 color--blue-500 mb-0 s-14"> 21 years or above </h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="fbox-ico ico-14">
    ...
    <section id="reviews-1" class="py-80 shape--06 reviews-section-01">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    <div class="section-title mb-40">
                        <span class="color--green-300 text-uppercase mb-2 w-600 d-block">Explore Loan Options</span>
                        <h2 class="s-28 mb-5 w-700">Compare Available Loan Options in One Place</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col text-center">
                    <div class="owl-carousel brands-carousel-5">
                        <div class="brand-logo">
                            <img src="{{ asset('front/images/slider-image-1.png') }}" alt="review-avatar"
                                width="auto">
                        </div>
                        <div class="brand-logo">
                            <img src="{{ asset('front/images/slider-image-2.png') }}" alt="review-avatar"
                                width="auto">
                        </div>
                        <div class="brand-logo">
                            <img src="{{ asset('front/images/slider-image-3.png') }}" alt="review-avatar"
                                width="auto">
                        </div>
                        <div class="brand-logo">
                            <img src="{{ asset('front/images/slider-image-1.png') }}" alt="review-avatar"
                ...
                <div class="col-md-12 col-lg-12 col-xl-12">
                    <div class="form-holder">
                        <div class="contact-form-notice">
                            <p class="s-14">
                                <strong>Important Note:</strong> We ask our customers to make payments ONLY on our website arrowcapital.in and NOT through any other source, directly or indirectly.
                            </p>
                            ...
                            <p class="s-14">
                                ...
                                <br />
                                <strong>Mobile:</strong> {{ config('constant.COMPANY_MOBILE') }} | <strong> Email:</strong>
            ...
            <div class="modal-content p-30 border-radius-10">
                <form action="{{ route('self.apply.verify.otp') }}" method="post"
                    ...
                    <button type="submit" id="otpBtn"
                        ...
                        OTP <span class="fbox-ico ico-10">
                            <span class="flaticon-right-arrow  ico-20 ms-1"></span></span></button>
                </form>
            </div>
        </div>
    </div>
