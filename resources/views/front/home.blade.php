    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-6 col-md-6 mb-md-0 mb-3">
                <span class="color--green-300 mb-2 d-block">🔶 Quality financial services to strengthen your future
                </span>
                <h1>Get the Right Loan
                    at the <span class="color--green-300">Right Time.</span>
                </h1>
                <p>Compare offers from 10+ industry-leading NBFCs, apply entirely online and get disbursed fast — with
                    zero impact on your CIBIL score while you explore.</p>
                <div class="d-flex mt-3 justify-content-md-start justify-content-center">

                    <a
                        class="btn r-100 btn--green-300 hover--tra-black last-link d-flex align-items-center me-3 btn-sm">Apply
                        Now <span class="fbox-ico ico-10 mb-0"> <span
                                class="flaticon-right-arrow  ico-20 ms-1"></span></span> </a>
                    <a class="btn r-100 btn--tra-black hover--theme btn-sm">Hire a Loan Agent<span class="fbox-ico ico-10"> <span class="flaticon-right-arrow  ico-20 ms-1"></span></span>
                    </a>
                </div>
                <!-- FEATURES-6 WRAPPER -->
                    ...
                    <div class="fbox-7 bg--white-100 fb-1 r-20 h-100 w-100 text-start position-relative border-0 mb-0">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <span class="color--green-300 bg--green-200 px-3 py-2 r-100 s-12 w-700"> <span
                                    class="fbox-ico ico-10 mb-0"> <span
...
<section class="py-80 ct-02 content-section division bg--blue-100" id="company">
    <div class="container">
        <div class="row justify-content-center">
                    ...
                    <div class="row text-center gy-3 gx-3">
                        <div class="col-6 col-md-6 mb-lg-0">
                            <div class="statistic-block text-start bg--green-200 r-12 p-3 h-100">
                                ...
                                <div class="statistic-txt">
                                    <p class="s-16 w-400 text-dark mt-0">Customers Served</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-6 mb-lg-0">
                        ...
                        <div class="col-6 col-md-6 mb-lg-0">
                            <div class="statistic-block text-start bg--green-200 r-12 p-3 h-100">
                                ...
                                <div class="statistic-txt">
                                    <p class="s-16 w-400 text-dark mt-0">Workforce</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-6 mb-lg-0">
            ...
            <div class="col-lg-7 col-md-6 col-12 mt-md-0 mt-3
            ps-5">
                <div class="txt-block right-column mb-0">
                    <span class="color--green-300 text-uppercase">About us</span>
                    <h2>Quality financial services to <span class="color--green-300">strengthen your future</span></h2>
                    <p>Arrow Capital is founded on a simple principle: obtaining financial guidance should be simple,
                        straightforward and honest. We work with individuals who are looking for the right direction
                        when exploring borrowing options, helping them move forward with clarity and confidence.</p>
                    <p>Every person's financial situation is different, which is why our approach focuses on listening
                        first. We understand your precise requirements, then guide you through the steps involved in the
                        loan process so there are never any surprises later.</p>
                    <p>Through our network of trusted NBFC partners, we help you access a range of loan products
                        tailored to what you actually need — without the pressure and without the guesswork.</p>
                    <a href="#" class="color--theme w-700">Explore how it works <span class="fbox-ico ico-10"> <span
                                class="flaticon-right-arrow  ico-20 ms-1"></span></span></a>
                </div>
            </div>
            ...
            <div class="col-md-10 col-lg-10">
                <div class="section-title mb-40">
                    <div class="d-flex justify-content-center align-items-center">
                        <h2 class="s-28 mb-5 w-700">How to apply for <span class="color--green-500">loan?</span></h2>
                        <div class="">
...
<div id="statistic-1" class="statistic-section division pb-0 bg--blue-100">
    <div class="container">
        <div class=" statistic-5-wrapper r-20">
            <div class="row align-items-center py-60">
                    ...
                    <div class="row g-4">
                        <div class="col-6 col-md-3 mb-lg-0 mb-4">
                            <div class="statistic-block">
                                ...
                                <div class="statistic-txt">
                                    <h5 class="s-16 w-400 text-white">Customers Served</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3 mb-lg-0 mb-4">
                        ...
                        <div class="col-6 col-md-3 mb-lg-0 mb-4">
                            <div class="statistic-block">
                                ...
                                <div class="statistic-txt">
                                    <h5 class="s-16 w-400 text-white">Workforce</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3 mb-lg-0 mb-4">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-10">
                <div class="section-title mb-40">
                    ...
                    <h2 class="s-28 mb-5 w-700">Strengthen Your Financial <span class="color--green-300">Aspects
                            Smartly</span></h2>
                    <p class="s-16 color--grey mt-0">Choose the plan that suits your needs — apply yourself or let an
                        expert do it for you.</p>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    <div class="fbox-5 fbox--hover fb-2 border r-20 text-start card-left h-100">
                        ...
                        <div class="fbox-txt">
                            ...
                            <p class="mb-20">Enjoy a hassle-free journey without consultation, connect logins, and
                                personalise the offers from our trusted NBFC partners.</p>
                ...
                <div class="col-md-6">
                    <div class="fbox-5 fbox--hover fb-2 border r-20 text-start card-right">
                        <div class="fbox-txt">
                            ...
                            <p class="mb-20 text-white">Relax with our expert team — we take the entire process
                                end-to-end and walk
                                you through each step, ensuring a seamless experience.</p>
                            <div class="cbox-1 ico-15">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-9">
                <div class="section-title mb-40">
                    ...
                    <h2 class="s-28 mb-5 w-700">Why Choose <span class="color--green-300">Arrow Capital?</span></h2>
                    <p class="s-16 color--grey mt-0">Our team of experts strives to provide the best services to help
                        you achieve your goals easily.</p>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 row-cols-1 row-cold-sm-2 row-cols-md-3 row-cols-lg-3">
                <div class="col d-flex">
                    <div class="fbox-7 bg--white-100 fb-1 r-12 h-100 w-100 text-start">
                        ...
                        <div class="fbox-txt">
                            <h6>Access To Multiple NBFCs</h6>
                            <p class="color--grey mt-0">A wide network of trusted lending partners means we find the
                                option that actually fits your case.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col d-flex">
                    <div class="fbox-7 bg--white-100 fb-1 r-12 h-100 w-100 text-start">
                        ...
                        <div class="fbox-txt">
                            <h6>Dedicated Expert Assigned</h6>
                            <p class="color--grey mt-0">Have questions? A dedicated expert stays assigned to you from
                                first enquiry to disbursement.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col d-flex">
                    <div class="fbox-7 bg--white-100 fb-1 r-12 h-100 w-100 text-start">
                        ...
                        <div class="fbox-txt">
                            ...
                            <p class="color--grey mt-0">Apply from anywhere with a straightforward digital journey that
                                takes minutes, not weeks.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col d-flex">
                    <div class="fbox-7 bg--white-100 fb-1 r-12 h-100 w-100 text-start">
                        ...
                        <div class="fbox-txt">
                            <h6>No Impact On CIBIL Score</h6>
                            <p class="color--grey mt-0">Browse and compare offers freely — exploring your options never
                ...
                <div class="col d-flex">
                    <div class="fbox-7 bg--white-100 fb-1 r-12 h-100 w-100 text-start">
                        ...
                        <div class="fbox-txt">
                            <h6>Personalised Tracking Portal</h6>
                            <p class="color--grey mt-0">See exactly where your application stands at every stage, with
                ...
                <div class="col d-flex">
                    <div class="fbox-7 bg--white-100 fb-1 r-12 h-100 w-100 text-start">
                        ...
                        <div class="fbox-txt">
                            <h6>Tailored Financial Solutions</h6>
                            <p class="color--grey mt-0">One-size never fits all; every offer is shaped around your
                                income, tenure and repayment comfort.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-10">
                <div class="section-title mb-40">
                    ...
                    <h2 class="s-28 mb-5 w-700">Calculate Your EMI in <span class="color--green-300"> Seconds</span>
                    </h2>

                    <p class="s-16 color--grey mt-0">Plan your finances more confidently!</p>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-10">
                    <div class="section-title mb-40">
                        ...
                        <h2 class="s-28 mb-5 w-700">Partnering with the best<span class="color--green-300">NBFCs</span>
                        </h2>
                        <p class="s-16 color--grey mt-0">Providing the best for our customers.</p>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-12">
                <div class="section-title mb-40">
                    ...
                    <h2 class="s-28 mb-5 w-700">Our Happy <span class="color--green-300">Customers</span></h2>
        ...
        <div class="row">
            <div class="col-md-6 md-mb-50">
                <div class="sec-title2 mb-40">
                    ...
                    <h2 class="s-28 mb-5 w-700">We are here to help you</h2>
                    <p class="description mt-0">Drop us a message with your basic information and our team will get back
                        to you shortly.</p>
                </div>
                            ...
                            <div class="row gx-2 gy-2">
                                ...
                                <div class="col-12">
                                    <div class="form-group form-floating s-14 w-600">
                                        ...
                                        <textarea id="form_message" name="desc" class="mb-0 form-control message pt-2"
            ...
            <div class="row p-md-5 p-3">
                <div class="col-lg-7 col-md-7">
                    <div class="banner-12-txt color--white mb-md-0 mb-3">
                        ...
                        <h3 class="s-32 w-700 mb-3">Apne Sapne Ko Do <br> <span class="color--theme"> Nayi Udaan</span>
                        </h3>
                        <span class="section-id rounded-id bg--tra-white color--white text-uppercase border-0">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="fbox-5 fb-2 border r-20 text-start card-left h-100">
                        ...
                        <div class="fbox-txt">
                            ...
                            <div class="mt-3">
                                <a href="" class="btn r-100 btn--green-300 hover--tra-black btn-sm">Instant Approval
