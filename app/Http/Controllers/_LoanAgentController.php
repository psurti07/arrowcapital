...
-----END PUBLIC KEY-----';       //header key
        ...
        try {
            ...
            if ($txStatus == "PAYMENT_SUCCESS") {
                ...
                if ($isEntry == 0) {
                    ...
                    sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for Arrow Capital’s Hire Agent Plan.', $sendGreetings, 3, $pdf);
    ...
    public function getOffer4(Request $request)
    {
        try {
            ...
            Cache::put('user_password', $password, $this->lifetime);
            //Log::info('order ID - ' .$orderid);
            $returnUrl = 'https://arrowcapital.in/api/loan-agent/big-offer-response';
            $curlurl = "https://api.zaakpay.com/api/paymentTransact/V8";
