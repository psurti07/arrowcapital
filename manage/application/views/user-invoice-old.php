                ...
                <tr>
                  ...
                  <td style="vertical-align:bottom;word-wrap:break-word;float:right;text-align:right;width:50%;">
                      ...
                      <div style="clear:both;margin-top:20px;">
                          ...
                          <br>
                          <b><?php echo $invdetails['orderinfo']->id; ?></b>
                          <br><br>
            ...
            <tbody id="lineitem">
                <tr>
                    <td style="font-size: 9pt;border-bottom: 1px solid #e3e3e3;background-color: #ffffff;color: #000000;padding: 10px 0px 10px 10px;" valign="top">
                        <span style="word-wrap: break-word;" id="tmp_item_name">Subscription Plan</span>
                        <br>
                        <span style="color: #727272;font-size: 9pt;white-space: pre-wrap;word-wrap: break-word;" id="tmp_item_description">Subscription Number - <?php echo $invdetails['orderinfo']->card_number; ?></span>
                    </td>
        ...
        <table style="width:100%;margin-top:3px;table-layout:fixed;border-spacing: 0;border-collapse: collapse;">
            <tbody>
                <tr>
                  ...
                  <td id="tmp_total" style="float:right;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:30%;" align="right" valign="middle"><b><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> <?php echo formatePriceIndia($invdetails['orderinfo']->amount); ?></b>
                      <br>
                  </td>
                </tr>
            </tbody>
