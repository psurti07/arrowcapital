...
background: linear-gradient(to right, #48b1bf, #06beb6); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */">
								...
								<div class="card-content text-center">
									<div class="card-body">
										...
										<fieldset class="form-group position-relative has-icon-left">
											<input type="email" name="emailid" class="form-control input-lg"
												id="user-email" placeholder="Email Id" tabindex="1" required
										...
										<button type="submit" id="submit-btn"
											class="btn btn-primary btn-md btn-block"><i class="ft-unlock"></i>
											LOGIN</button>

										<?php echo form_close(); ?>

										<div class="float-sm-center text-light text-center pt-2">
											<p class="m-0"><?php echo date("Y") . " &copy; " . COMPANY_NAME; ?></p>
										</div>
									</div>
								</div>
							</div>
	...
	<script src="<?php echo base_url('assets/vendors/js/forms/icheck/icheck.min.js'); ?>"
