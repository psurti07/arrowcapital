...
<script type="text/javascript">
  window.onload = function() {
    document.getElementById("109").className += " active";
    document.getElementById("109" + <?php echo $cardtype; ?>).className += " active";
  }
</script>
...
<div class="content-header row">
  <div class="content-header-left col-md-6 col-12 mb-1">
    <h1 class="content-header-title text-uppercase">
      <?php echo ($cardtype == 12) ? "Business" : "Personal"; ?> Subscription Plan List</h1>
  </div>
  <div class="content-header-right col-md-6 col-12 mb-1">
    <?php echo form_open('users/subscriptionlist/' . $cardtype, array('id' => 'filterForm', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                ...
                <tbody>
                  ...
                  if (count($subscriptionlist)) {
                    ...
                    foreach ($subscriptionlist as $row) {
                      ...
                      echo "<td>" . anchor("users/subscriptionplan/{$row->userid}", $row->fullname, 'class="text-capitalize"') . "</td>";
