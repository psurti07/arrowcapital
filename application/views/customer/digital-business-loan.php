...
<div class="section-sm bg-lend-blue" id="home">
	<div class="container text-center">
		<h1 class="fw-light m-0 text-light">Business Loan </h1>
	</div><!-- end container -->
</div>
	...
	<div class="container">
		<div class="row">
			...
			<?php if($userdetails['step'] == "s1") { 
				echo form_open('customer/onlineprocess/userBusinessApply', array('id'=>'submitForm1', 'class'=>'contact-form', 'novalidate'=>'novalidate')); ?>
