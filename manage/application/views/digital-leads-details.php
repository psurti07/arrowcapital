              ...
              <div class="card-content collapse show">
                <div class="card-body">
                    ...
                    <dl class="row">
                      ...
                      <dt class="col-md-8">
                        <?php 
                          if($userdetails['userinfo']->cardtype == 11) {
                            echo "Personal Subscription Plan";
                          }
                          else if($userdetails['userinfo']->cardtype == 12) {
                            echo "Business Subscription Plan";
                          }
                        ?>
                        </dt>
                    </dl>
...
<!-- Modal -->
<div class="modal fade text-left" id="convertlead" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" data-backdrop="static" data-keyboard="false" aria-hidden="true">
          ...
          <?php echo form_open('users/converttocustomer', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <div class="controls">
                  <input type="text" name="cardamount" id="cardamount" class="form-control" data-validation-regex-regex="[0-9]+" value="">
            ...
            <div class="form-actions text-right pb-0">
              ...
              <button type="submit" id="submit-btn" class="btn btn-primary btn-min-width">Create An Account</button>
            </div>
          <?php echo form_close(); ?>
      </div>
    </div>
