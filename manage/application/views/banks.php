...
<script type="text/javascript">   
  ...
  <div class="content-header row">
	  ...
	  <div class="content-header-right btn-group-sm text-right col-md-4 col-12 mb-1">
	      <a href="<?php echo site_url('banks/addForm'); ?>" target="_self" class="btn btn-outline-primary"><i class="la la-plus"></i> Add Bank</a>
	  </div>
	</div>
                      ...
                      <?php
                        if(count($banklist)) {
                            ...
                            echo "</td>";
                        		...
                        		echo "<td class='text-center' width='50'>".anchor("banks/editForm/{$row->id}",'<i class="la la-pencil"></i>','class="btn btn-icon btn-outline-success btn-sm"')."</td>";
