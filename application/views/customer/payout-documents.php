            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-hero-haddig text-center">
                        <h1 class="text-dark">Payout Documents</h1>
                    </div>
                </div>
            </div>
        </div>
						...
						<ul class="mt-4">
							<li class="font-18">
								<span class="pricing-icon">
									<img src="<?=$docflags['gstdoc'] == 1 ? base_url('assets/img/check.png') : base_url('assets/img/cross.png') ?>" alt="" height="20px" width="20px">
								</span>
								GST Documents
							</li>
				...
				<div class="row">
					...
					<?php if($docflags['gstdoc'] == 0) { ?>
						<div class="col-lg-12">
							<div class="single-price">
								<div class="price body">
									<form id="submitForm11" enctype="multipart/form-data" method="post" accept-charset="utf-8">
										<input type="hidden" name="doc" value="gstdoc" required>
										<input type="hidden" name="customerid" value="<?php echo $profiledata->id; ?>" required>
										<h6>GST Document *</h6>
										<input id="user_gstdoc_number" type="text" name="userfile_number" class="form-control" placeholder="GST Number *" value="<?php echo ($docflags['gstdoc_number'] != 0) ? $docflags['gstdoc_number'] : ''; ?>" required>
										<div class="error-message" id="user_gstdoc_number-message"></div>
										<div class="form-group input-group mt-4">
											<input type="file" name="userfile" id="user_gstdoc" class="form-control" aria-required="true" required accept=".jpg,.jpeg,.png,.pdf,.doc,.docx,.pdf">
					...
					<?php if($docflags['aadharcard'] == 0) { ?>
						<div class="col-lg-12">
							<div class="single-price">
								<div class="price body">
									<form action="<?=base_url('customer/profile/uploadpayoutdocument');?>" id="submitForm12" class="" enctype="multipart/form-data" novalidate="novalidate" method="post" accept-charset="utf-8">
					...
					<?php if($docflags['pancard'] == 0) { ?>
						<div class="col-lg-12">
							<div class="single-price">
								<div class="price body">
									<form action="<?=base_url('customer/profile/uploadpayoutdocument');?>" id="submitForm13" class="" enctype="multipart/form-data" novalidate="novalidate" method="post" accept-charset="utf-8">
