    ...
    <section id="hero-7" class="bg--fixed hero-section">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 col-md-12 col-12 order-2 order-md-2 order-lg-1 m-auto"> 
                        <div class="img-block">
                            <img src="{{ asset('front/images/offer/la-big-benefit-offer.jpg') }}" alt="selfapply nbfc list" class="img-fluid w-100">
                        </div>
                   </div>
        <div class="col-lg-6 col-md-12 col-12 self-apply-form  order-1 order-md-1 order-lg-2">
                    <div id="hero-8-form" class="r-06">
                        ...
                        <p class="p-sm mt-3 mb-0 text-start">By submitting the form & proceeding, you agree to the <a href="{{ route('front.terms.conditions') }}" target="_blank" class="text-dark text-decoration-none">Terms</a>  and <a href="{{ route('front.privacy.policy') }}" target="_blank" class="text-dark text-decoration-none"> Privacy Policy</a> of Arrow Capital.</p>
                    </div>
                </div>
            </div>
        </div>
