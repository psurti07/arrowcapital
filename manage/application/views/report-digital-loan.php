...
<script type="text/javascript">
  window.onload = function(){
      document.getElementById("124").className += " active";
      document.getElementById("124" + <?php echo $loanid; ?>).className += " active";
  }
</script>
<style>
	.overlay {
  ...
  <div class="content-header row">
	  <div class="content-header-left col-md-12 col-12 mb-1">
	    <h1 class="content-header-title text-uppercase">Report - Digital Leads - <?php echo $loanname; ?></h1>
	  </div>
	</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('.model_data').on('click', function() {
			...
			if (month) {
				$.ajax({
					url: '<?php echo base_url("report/digitalleadsdaywise"); ?>',
					type: "POST",
					data: {
						'loantype': loantype,
						'month': month,
