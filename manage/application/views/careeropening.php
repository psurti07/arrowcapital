...
<script type="text/javascript">   
  ...
  <div class="content-header row">
	  ...
	  <div class="content-header-right btn-group-sm text-right col-md-4 col-12">
	      <a href="<?php echo site_url('career/addForm'); ?>" target="_self" class="btn btn-outline-primary"><i class="la la-plus"></i> Add Openings</a>
	  </div>
	</div>
                        ...
                        if(count($openinglist)) {
                            ...
                            if($row->isActive == 1) {
                              ...
                              echo "<td class='text-center'>".anchor("career/changestatus/{$row->isActive}/{$row->id}",'Inactive','class="btn btn-icon btn-outline-danger btn-sm"')."</td>";
                        		...
                        		echo "<td class='text-center' width='50'>".anchor("career/editForm/{$row->id}",'<i class="la la-pencil"></i>','class="btn btn-icon btn-outline-success btn-sm"')."</td>";
