              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <?php echo form_open('loan/addAppstatus', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                        ...
                        <div class="form-body">
                          ...
                          <div class="row">
                              <div class="form-group col-md-6">
                                ...
                                <input type="hidden" name="applicationid" value="<?php echo $appdetails->id; ?>" class="form-control">
                              </div>

                              <div class="form-group col-md-6">
                                <h4 class="text-capitalize">Customer Name - <strong><?php echo $appdetails->fullname; ?></strong></h4>
                              </div>
                          </div>
                          ...
                          <div class="row">
                              <div class="form-group col-md-6">
                                ...
                                <div class="controls">
                                    <select name="statusid" id="statusid" data-placeholder="Select Application Status" class="select2 form-control" onchange="return statusChecksum(this.value);" required data-validation-required-message="Application status is required">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <div class="controls">
                                    <input type="date" name="recdate" id="datepicker" class="form-control" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d', strtotime(date("Y-m-d", strtotime("-3 day")))); ?>" required data-validation-required-message="Status date is required"/>
                                </div>
                              </div>
                          </div>
                          ...
                          <div class="row">
                              <div class="form-group col-md-12">
                                ...
                                <div class="controls">
                                    <select name="bankid" id="bankid" data-placeholder="Select Bank Name" class="select2 form-control" required data-validation-required-message="Bank is required">
                        ...
                        <div id="otherdetails" style="display: none;">
                          ...
                          <div class="row">
                              <div class="form-group col-md-6">
                                <h5>Process Fees</h5>
                                <div class="controls">
                                    <input type="text" name="processfees" id="processfees" class="form-control">
                                </div>
                              </div>
                          ...
                          <div class="row">
                              <div class="form-group col-md-6">
                                <h5>Monthly EMI</h5>
                                <div class="controls">
                                    <input type="text" name="monthlyemi" id="monthlyemi" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <div class="controls">
                                    <input type="file" name="sanctionletter" id="sanctionletter" class="form-control">
                                </div>
                              </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="form-group col-md-12">
    			                  ...
    			                  <div class="controls">
    			                      <select class="select2 form-control" id="predefinemessage" onchange="return premessage(this.value);">
                        ...
                        <div class="form-actions text-right">
                          <a href="<?php echo site_url('loan/application'); ?>" class="btn btn-outline-light">CANCEL</a>
...
<script type="text/javascript">
  ...
  function statusChecksum(statusid) {
      ...
      $.ajax({
          url : "<?php echo site_url('loan/getstatusremarks/'); ?>" + statusid,
          type:'POST',
          dataType: 'json',
          cache: false,
          processData: false,
          success: function(response) {
              ...
              if(response['success'] == true) {
                  $("#predefinemessage").append(response['remarkslist']);
              } 
           }
      });
  }
