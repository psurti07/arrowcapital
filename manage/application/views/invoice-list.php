                ...
                <tbody>
                  ...
                  if (count($datalist)) {
                    ...
                    foreach ($datalist as $row) {
                      ...
                      if ($row['inv_for'] == 1 || $row['inv_for'] == 2) {
                        echo anchor("users/downloadinvoice/{$row['userid']}/{$row['memberid']}", '<i class="la la-print"></i>', 'class="btn btn-icon btn-outline-primary btn-sm" target="_blank"');
                      } 
                      echo "</td>";
...
<!-- Modal -->
<div class="modal text-left" id="refundamountmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" data-backdrop="static" data-keyboard="false" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-actions text-right pb-0">
          ...
          <button type="submit" id="submit-btn" class="btn btn-primary btn-min-width">Refund Now</button>
        </div>
        <?php echo form_close(); ?>
      </div>
    </div>
