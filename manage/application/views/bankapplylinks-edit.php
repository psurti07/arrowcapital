  ...
  window.onload = function(){
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-8 col-12 mb-1">
        <h1 class="content-header-title text-uppercase">Edit Bank Apply Direct Link</h1>
      </div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <?php echo form_open('banks/editApplyLink', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                        <div class="form-body">
                          <input type="hidden" name="id" value="<?php echo $linkdetails->id; ?>" required>

                          <div class="form-group btn-group-toggle" data-toggle="buttons">
                            <div class="btn-group">
                              <label class="btn btn-outline-primary <?php echo ($linkdetails->loantype == 11) ? 'active' : ''; ?>">
                                <input type="radio" name="loantype" value="11" autocomplete="off" <?php echo ($linkdetails->id == 11) ? 'checked' : ''; ?>>Personal Loan
                              </label>
                              <label class="btn btn-outline-primary <?php echo ($linkdetails->loantype == 12) ? 'active' : ''; ?>">
                                <input type="radio" name="loantype" value="12" autocomplete="off" <?php echo ($linkdetails->id == 12) ? 'checked' : ''; ?>>Business Loan
                              </label>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <textarea name="applyurl" class="form-control" required data-validation-required-message="Apply URL is required" rows="5"><?php echo $linkdetails->applyurl; ?></textarea>
                              <div class="help-block font-small-3"></div>
                            </div>
                          </div>
                        </div>
