    ...
    <section id="features-11" class="py-80 features-section division">
        <div class="container">
            ...
            <div class="fbox-wrapper">
                <div class="row row-cols-1 row-cols-md-2 rows-2 g-3">
                    <div class="col">
                        <div class="fbox-8 h-100">
                    ...
                    <div class="col">
                        <div class="fbox-8 h-100">
                            ...
                            <div class="fbox-txt">
                                <h6 class="s-18 w-700 mb-5">Growth-Oriented Culture</h6>
                                <p class="s-16 color--grey mt-0">We’ll bring out the best in you so that your growth is nurtured impeccably.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
