  ...
  window.onload = function(){
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-8 col-12 mb-1">
        <h1 class="content-header-title text-uppercase">Add ROI Package</h1>
      </div>
      <div class="content-header-right btn-group-sm text-right col-md-4 col-12 mb-1">
          <a href="<?php echo site_url('banks/roipackages'); ?>" target="_self" class="btn btn-outline-primary"><i class="la la-list-ol"></i> Packages List</a>
      </div>
    </div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <?php echo form_open('banks/addRoiPackage', array('id'=>'submitForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                        <div class="form-body">
                          <div class="form-group btn-group-toggle" data-toggle="buttons">
                            <div class="btn-group">
                              <label class="btn btn-outline-primary active">
                                <input type="radio" name="loantype" value="11" autocomplete="off" checked>Personal Loan
                              </label>
                              <label class="btn btn-outline-primary">
                                <input type="radio" name="loantype" value="12" autocomplete="off">Business Loan
                              </label>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="text" name="roi" class="form-control" required data-validation-regex-regex="[0-9,.]+" data-validation-required-message="ROI is required">
                              <div class="help-block font-small-3"></div>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="text" name="termsyears" class="form-control" required data-validation-regex-regex="[0-9,.]+" data-validation-required-message="Terms is required">
                              <div class="help-block font-small-3"></div>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="text" name="termsmonths" class="form-control" required data-validation-required-message="Terms is required">
                              <div class="help-block font-small-3"></div>
                            </div>
                          </div>
                        </div>
