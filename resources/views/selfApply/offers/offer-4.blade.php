        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 col-md-12 col-12 order-2 order-md-2 order-lg-1 m-auto">
                    <div class="img-block">
                        <img src="{{ asset('front/images/offer/sa-star-offer.jpg') }}" alt="selfapply nbfc list"
                ...
                <div class="col-lg-6 col-md-12 col-12 self-apply-form  order-1 order-md-1 order-lg-2">
                    <div id="hero-8-form" class="r-06">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="mobile" id="mobile"
                                            class="numeric-input form-control name" placeholder="Mobile*" autocomplete="off"
                                            maxlength="10" minlength="10" inputmode="numeric" value="{{ old('mobile') }}">
                                    </div>
                        ...
                        <p class="p-sm mt-3 mb-0 text-start">By submitting the form & proceeding, you agree to the <a
                                ...
                                class="text-dark text-decoration-none"> Privacy Policy</a> of Arrow Capital.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    <div class="section-title text-center mb-40">
                        ...
                        <p class="s-16 color--grey mt-0">We Give Many Reasons For Our Customers To Shower Praises On Us!
                        </p>
                    </div>
                </div>
            </div>
