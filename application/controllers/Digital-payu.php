...
class Digital extends CI_Controller
{
	...
	public function getpreApproval()
	{
		...
		/*$data4 = array(
			...
			"template"=> array(
					...
					"languageCode"=> "en",
					"headerValues"=> array(
						"https://interaktprodmediastorage.blob.core.windows.net/mediaprodstoragecontainer/72dbd5bc-b961-462d-af75-5f3115ea482f/message_template_media/lmqSsUQgGyoj/cashe26aug.jpg?se=2029-08-20T11%3A34%3A22Z&sp=rt&sv=2019-12-12&sr=b&sig=KTucMRLc9cR8l8EyVRKcfxxqkenk56Oq0C8nHpK9VKQ%3D"
					),
					"bodyValues"=> array(
	...
	public function buycardDigital()
	{
		...
		if (isset($_POST["status"]) && $_POST["status"] != "") {
			...
			if ($status == 'success') {
				$isentry = $this->Site_Digital_Model->checksubscriptionentry($mihpayid);
